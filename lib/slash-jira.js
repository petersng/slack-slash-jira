...
function slashJira (token, options) {
  ...
  this.jiraCommand = options.jiraCommand;
...
slashJira.prototype.handle = function (req, cb) {
  if (this.jiraCommand == "displayIssue") {
    this._handleShowIssue(req, cb);
  }
  else if (this.jiraCommand == "addBug") {
    this._handleAddBug(req, cb);
  }
  else if (this.jiraCommand == "addFeature") {
    this._handleAddFeature(req, cb);
  }
  else if (this.jiraCommand == "addTask") {
    this._handleAddTask(req, cb);
  }
};

slashJira.prototype._handleAddBug = function(req, cb) {
  cb(null, "Not implemented yet.");
}

slashJira.prototype._handleAddFeature = function(req, cb) {
  cb(null, "Not implemented yet.");
}

slashJira.prototype._handleAddTask = function(req, cb) {
  cb(null, "Not implemented yet.");
}

slashJira.prototype._handleShowIssue = function(req, cb) {
